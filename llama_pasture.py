...
# A program that shows llamas having a decent day with a crazy environment
...
while not done:
    ...
    # Controls the Sun/Moon's boundaries and the day cycle
    if s_pla[0] > 850:
        estella = not estella
